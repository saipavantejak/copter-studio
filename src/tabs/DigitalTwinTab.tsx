  ...
  return (
    <main className="max-w-[1000px] mx-auto p-5 space-y-5">
      <div>
        ...
        <p className="text-sm text-zinc-500 mt-0.5">Upload a real drone flight CSV (from hardware) and automatically fit physics parameters. Calibrated simulator will match your real drone's behaviour.</p>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="space-y-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            <h3 className="text-sm font-bold text-zinc-200 mb-3">What the calibrator fits</h3>
            <div className="space-y-2 text-xs text-zinc-400">
              {[
                ...
                <div key={p as string} className="flex gap-3">
                  <span className="text-teal-400 font-bold w-28 shrink-0">{p as string}</span>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
            <h3 className="text-sm font-bold text-zinc-200 mb-3">How to get your flight CSV</h3>
